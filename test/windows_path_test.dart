...
test("parent", () {
  ...
  expect(Path("temp1\\temp2\\foo.tar.gz").parent().unwrap(), Path("temp1\\temp2"));
  expect(Path("temp1\\temp2\\\\foo.tar.gz").parent().unwrap(), Path("temp1\\temp2"));
...
test("withExtension",(){
  ...
  expect(Path("C:\\tmp\\foo.tar.gz").withExtension("tar.gz"), Path("C:\\tmp\\foo.tar.tar.gz")); 
...
test("withFileName",(){
  ...
  expect(Path("C:\\tmp\\foo.tar.gz").withFileName("bar"), Path("C:\\tmp\\bar")); 
